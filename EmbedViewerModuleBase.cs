...
namespace DotNetNuke.Modules.EmbedViewer
{
    ...
    /// are accessible to your module's controls (that inherity from EmbedViewerModuleBase
    /// 
    /// </summary>

    public class EmbedViewerModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
